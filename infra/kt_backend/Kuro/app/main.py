...
* **Get users per provider type per protocol (last 24h)**
* **Get failure reason of existing users (last 24h)**
* **Get users summary - success auth, access & failure & total events (last 24h)**
"""
